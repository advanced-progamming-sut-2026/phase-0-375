...
public final class TangleKelpAnim {
    private TangleKelpAnim() {}

    public static void register(PlantAnimOverrides overrides) {
        overrides.register("Tangle Kelp", TangleKelpAnim::resolve);
    }
    ...
    private static AnimPose resolve(PlantInstance plant, PamCatalog.PamEntry entry, PlantAnimRole role) {
        ...
        return switch (role) {
            ...
            case ATTACK -> AnimPose.once(entry.path(), "attack_submerge", role);
